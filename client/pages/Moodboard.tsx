...
export default function Moodboard() {
  ...
  const onFiles = async (files: FileList | null) => {
    ...
    for (const f of Array.from(files)) {
      ...
      setImages((prev) => [
        { id, name: f.name, createdAt: Date.now(), blob, url },
        ...prev,
      ]);
    }
  };
    ...
    <div className="container py-16">
      <header className="max-w-3xl">
        ...
        <p className="mt-3 text-muted-foreground">
          A curated collection of visual inspiration.
        </p>
      </header>
              ...
              >
                ...
                <figcaption className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition">
                  <button
                    ...
                    className="px-2 py-1 text-xs bg-black/60 text-white"
                  >
                    Remove
                  </button>
                </figcaption>
